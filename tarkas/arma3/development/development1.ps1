#Instance Configuration Development 1 Server
$configPath = 'https://raw.githubusercontent.com/7Cav/service-level-configs/master/tarkas/arma3/development/development1.json'
